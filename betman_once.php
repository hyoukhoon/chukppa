...
$query2="SELECT gmTs FROM python.xc_betman where gmId='G101' and left(saleStartDate,10)>='".$today."' and saleStatus = 'SaleBefore'";
...
if($gTs){//진행중인 승부식이 있으면
	...
	//$today_game="https://www.chukppa.com/b240117-2.html";
	...
	*/
	...
	//		print_r($r);
			...
			$gd=explode(" ",$gameDate);
			$xgid=0;
			$query3="SELECT gid FROM xc_games_fs  where gamedate='".$gd[0]."' and gametime='".$gd[1]."' and hometeambetman='".$homeName."' and awayteambetman='".$awayName."'";
			//echo $query3."<br>";
