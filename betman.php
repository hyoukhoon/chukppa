...
//	exit;
	...
	*/
	...
	//		print_r($r);
			...
			$gd=explode(" ",$gameDate);
			$xgid=0;
			$query3="SELECT gid FROM xc_games_fs  where gamedate='".$gd[0]."' and gametime='".$gd[1]."' and trim(hometeambetman)='".trim($homeName)."' and trim(awayteambetman)='".trim($awayName)."'";
			//echo $query3."<br>";
