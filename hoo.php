...
if(!$_SESSION['loginValue']['SEMAIL']){
	echo "<script>alert('후방짤은 회원만 볼 수 있습니다. 로그인 하십시오.');location.href='/member/login.php'</script>";
 	exit;
 }
?>
...
<main class="container">
  ...
  <div class="my-3 p-3 bg-body rounded shadow-sm">
    <h6 class="border-bottom pb-2 mb-0"><span class="material-symbols-outlined" style="vertical-align: text-bottom;">shield_lock</span> 후방짤 </h6>
<?php
...
<?php }?>
	  <div class="pb-3 mb-0 small lh-sm border-bottom w-100" onclick="moveurl('<?php echo $p->_source->url;?>')">
...
<a href="/board/write.php?multi=<?php echo $multi;?>" class="btn btn-dark">등록</a>
</div>
